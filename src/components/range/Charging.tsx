...
const RangeChargingSection = () => {
  ...
  return (
    <section id="range-charging" className="py-32 bg-black text-white relative">
      ...
      <div className="relative max-w-[1400px] mx-auto px-8 md:px-16 lg:pl-32">
          ...
          {rangeStats.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="font-light text-5xl md:text-6xl mb-3 tracking-tight">{stat.value}</div>
                <div className="text-white/40 text-xs uppercase tracking-widest font-light">{stat.label}</div>
              </motion.div>
            )
          })}
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-32">
          {chargingOptions.map((option, index) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 border border-white/10 flex items-center justify-center mb-8 group-hover:border-white/30 transition-colors duration-500">
                  <IconComponent className="w-6 h-6 text-white/60 group-hover:text-white transition-colors duration-500" strokeWidth={1} />
                </div>
                <h3 className="font-light text-2xl mb-4 tracking-tight">{option.type}</h3>
                <div className="font-light text-4xl mb-6 text-white">{option.time}</div>
                <p className="text-white/50 font-light text-sm leading-relaxed">{option.description}</p>
              </motion.div>
            )
          })}
        </div>
        ...
        >
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h3 className="font-light text-4xl md:text-5xl tracking-tight mb-8 leading-tight">
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <div className="font-light text-4xl mb-2 text-white">{item.value}</div>
                      <div className="text-white/40 text-xs uppercase tracking-widest font-light">{item.label}</div>
                    </div>
                  </motion.div>
                )
              })}
