...
const EcoRiderPage = () => {
  ...
  const specifications = [
    ...
    },
    {
      ...
      specs: [
        { 
          label: 'Display', 
          value: 'Digital LCD with Bluetooth', 
          icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        { 
          label: 'Suspension', 
          value: 'Telescopic (Front), Dual (Rear)', 
          icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  const features = [
    {
      ...
      description: 'Zero emissions with energy-efficient motor for guilt-free urban commuting',
      icon: (
    ...
    },
    {
      ...
      description: 'Connect your smartphone for navigation, diagnostics, and remote control',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
        </svg>
    ...
    },
    {
      ...
      description: 'Recover energy while braking to extend your range automatically',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      title: 'LED Lighting',
      description: 'Full LED setup with auto headlamps and DRLs for better visibility',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Premium suspension and ergonomic seating for all-day comfort',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Fewer moving parts means less maintenance and lower running costs',
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437l1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008z" />
        </svg>
  ...
  const colors = [
    { name: 'Midnight Black', hex: '#1a1a1a', image: '/images/CD_EV15533.jpg' },
    { name: 'Pearl White', hex: '#f5f5f5', image: '/images/CD_EV15533.jpg' },
    { name: 'Ocean Blue', hex: '#1e40af', image: '/images/CD_EV15533.jpg' },
    { name: 'Sunset Red', hex: '#dc2626', image: '/images/CD_EV15533.jpg' },
  ]
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        >
          <motion.div
            ...
            className="mb-6"
          >
            <span className="inline-block px-6 py-2 border border-blue-500/30 rounded-full text-sm tracking-widest uppercase text-blue-400">
              Eco Rider
            </span>
          </motion.div>
          ...
          >
            Perfect for daily commutes with impressive range and eco-friendly performance
          </motion.p>
          ...
          >
            <button
              ...
              className="px-12 py-5 bg-white text-black font-medium rounded-full hover:bg-zinc-200 transition-all duration-300 flex items-center gap-3"
            >
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-zinc-500 text-lg">
              Sleek, modern, and built for the city
            </p>
          </motion.div>
                  ...
                  <div
                    className={`w-16 h-16 rounded-full transition-all duration-300 ${
                      selectedColor.name === color.name
                        ? 'ring-4 ring-white/40 scale-110'
                        : 'ring-2 ring-zinc-800 hover:ring-white/20'
                    }`}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="p-8 bg-zinc-900/50 backdrop-blur-sm rounded-2xl border border-zinc-800/50 hover:border-zinc-700/50 transition-all duration-500 group"
              >
                  ...
                  {category.specs.map((spec) => (
                    <div key={spec.label} className="flex justify-between items-center group/spec">
                      <div className="flex items-center gap-3">
                        <span className="text-blue-400 group-hover/spec:scale-110 transition-transform">
                          {spec.icon}
                        </span>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-zinc-500 text-lg mb-12">
              See how Eco Rider stacks up against our other models
            </p>
          </motion.div>
              ...
              <tbody>
                {[
                  ...
                  >
                    ...
                    <td className="py-6 px-6 text-center font-light text-blue-400">{row.eco}</td>
                    <td className="py-6 px-6 text-center font-light">{row.city}</td>
                    <td className="py-6 px-6 text-center font-light">{row.velocity}</td>
                  </motion.tr>
                ))}
              </tbody>
            </table>
          ...
          >
            ...
            <div className="relative z-10 text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-zinc-400 mb-12">
                Experience the Eco Rider yourself. Book a test ride today.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <button
                  onClick={() => setIsBookModalOpen(true)}
                  className="px-12 py-5 bg-white text-black font-medium rounded-full hover:bg-zinc-200 transition-all duration-300"
                >
                  <span className="tracking-wider uppercase text-sm">Book Test Ride</span>
                </button>
                <Link
